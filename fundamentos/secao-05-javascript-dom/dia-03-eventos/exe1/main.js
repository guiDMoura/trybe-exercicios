...
//  - Note que uma das caixas está um pouco acima das outras. Por que isso ocorre?       -Porque só ela está vinculada a classe .tech
...
myWebpage.addEventListener('dblclick', () => {
  window.location.replace('https://betribe.com/')
})
